...
export function UpdateChecker() {
  ...
  if (state.status === "available") {
    return (
      <div className="bg-primary/95 text-primary-foreground px-4 py-3 text-sm flex items-center justify-between gap-4 animate-in slide-in-from-top">
  ...
  if (state.status === "downloading") {
    return (
      <div className="bg-primary/95 text-primary-foreground px-4 py-3 text-sm flex items-center gap-3">
