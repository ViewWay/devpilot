const zh = {
  ...
  agents: "代理",
  selectAgent: "选择代理",
  planModeActive: "规划模式已激活 — 代理正在规划，暂不执行操作",
  workingDir: "工作目录",
  systemPrompt: "系统提示词",
  ...
  selectFile: "选择文件",
  editorEmpty: "没有打开的文件",
  editorEmptyHint: "双击文件树中的文件以在编辑器中打开",
  openPreview: "打开预览",
  loading: "加载中...",
  ...
  "a11y.toolCallGroup": "工具调用分组",
  "a11y.toolCallRunning": "运行中",
  "a11y.toolCallDone": "已完成",
  "a11y.toolCallError": "错误",
  "ranTool": "执行了 {tool}",
  "ranTools": "执行了 {count} 个工具: {tools}",
  "approvalFileEdit": "文件编辑预览",
  "approvalNewContent": "新内容",
  "approvalOldContent": "当前内容",
  "approvalDiffPreview": "差异预览",
  "approvalShowDiff": "显示差异",
  "approvalHideDiff": "隐藏差异",
  "approvalCommand": "命令",
  ...
  // --- Hooks ---
  hooks: "钩子",
  hooksDesc: "配置在工具执行前后运行的 Shell 命令。",
  addHook: "添加钩子",
  removeHook: "删除钩子",
  hookName: "钩子名称",
  hookCommand: "Shell 命令",
  hookCommandPlaceholder: "例如 echo '工具已执行'",
  hookEvent: "事件",
  hookTimeout: "超时（秒）",
  hookEnabled: "已启用",
  hookDisabled: "已禁用",
  hookPreTool: "工具执行前",
  hookPostTool: "工具执行后",
  hookPreFileWrite: "文件写入前",
  hookPostShellExec: "Shell 执行后",
  hookTest: "测试",
  hookTesting: "测试中...",
  hookTestSuccess: "钩子测试通过",
  hookTestFailed: "钩子测试失败",
  hookStdout: "标准输出",
  hookStderr: "标准错误",
  hookExitCode: "退出码",
  hookNoHooks: "暂无钩子配置",
